...
const Project = () => {
    ...
    return (
        <div className='global project-container' id='projects'>
            <h2 className ='project__main-header'>Below are some of my projects that I'm either actively working on or have completed what I wanted to accomplish from that project.</h2> 
           <div className="project-grid">
               ...
               <ProjectItem title='Email Client' desc='With tools such as Java and JavaFX I created a email client that can fetch, send, and compose emails in the client. The client can handle these tasks concurrently using classes created in JavaFX.'/>
